    ...
    describe "line crossings"
        ...
        , test "wire distance" <|
            \_ ->
                let
                    wire =
                        allPoints "R8,U5,L5,D3"

                    result =
                        wireDistance ( 6, 5 ) wire

                    expected =
                        15
                in
                Expect.equal expected result
        , test "wire distance 2" <|
            \_ ->
                let
                    wire =
                        allPoints "U7,R6,D4,L4"
