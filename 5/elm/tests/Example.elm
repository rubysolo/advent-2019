            ...
            \_ ->
                let
                    ...
                    expected =
                        ...
                        , outputs = []
                        , errors = []
                        , log = [ Multiply { left = 33, right = 3, target = 4 } ]
                        }
                in
                Expect.equal actual expected
        , test "execute real" <|
            \_ ->
                let
                    ...
                    actual =
                        execute initial
                in
                Expect.equal actual.outputs [ 12440243, 0, 0, 0, 0, 0, 0, 0, 0, 0 ]
